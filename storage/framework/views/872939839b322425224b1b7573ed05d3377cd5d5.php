      ...
      <div class="row">
        <div class="col-12 col-md-6 offset-md-3 offset-md-3-right">
          <div class="tc">
            <ul class="horizontal f6 relative mb3 light-silver">
              <li class="mr2">
                ...
                <?php echo e(trans('auth.change_language_title')); ?>
            ...
            <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li>
                <?php if(App::isLocale($locale['lang'])): ?>
                  <?php echo e($locale['lang']); ?>

                <?php else: ?>
                <a href="<?php echo e(route('register')); ?>?lang=<?php echo e($locale['lang']); ?>"
                  title="<?php echo e(trans('auth.change_language', ['lang' => $locale['name-orig']], $locale['lang'])); ?>">
                  <?php echo e($locale['lang']); ?>
          ...
          <div class="signup-box">
            ...
            <?php if($first): ?>
              <h1><?php echo e(trans('auth.register_title_welcome')); ?></h1>
              <h2><?php echo e(trans('auth.register_create_account')); ?></h2>
            <?php else: ?>
              <h2><?php echo e(trans('auth.register_title_create')); ?></h2>
              <h3><?php echo trans('auth.register_login', ['url' => 'login']); ?></h3>
            <?php endif; ?>
            ...
            <form action="register" method="post">
              ...
              <div class="form-group">
                <label for="email"><?php echo e(trans('auth.register_email')); ?></label>
                <input type="email" class="form-control" id="email" name="email" placeholder="<?php echo e(trans('auth.register_email_example')); ?>" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
              </div>

              <div class="row">
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="first_name"><?php echo e(trans('auth.register_firstname')); ?></label>
                    <input type="text" class="form-control" id="first_name" name="first_name" placeholder="<?php echo e(trans('auth.register_firstname_example')); ?>" value="<?php echo e(old('first_name')); ?>" required autocomplete="given-name">
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <label for="last_name"><?php echo e(trans('auth.register_lastname')); ?></label>
                    <input type="text" class="form-control" id="last_name" name="last_name" placeholder="<?php echo e(trans('auth.register_lastname_example')); ?>" value="<?php echo e(old('last_name')); ?>" required autocomplete="family-name">
                  </div>
                </div>
              </div>

              <div class="form-group">
                <label for="password"><?php echo e(trans('auth.register_password')); ?></label>
                <input type="password" class="form-control" id="password" name="password" placeholder="<?php echo e(trans('auth.register_password_example')); ?>" required autocomplete="password">
              </div>

              <div class="form-group">
                <label for="password_confirmation"><?php echo e(trans('auth.register_password_confirmation')); ?></label>
              ...
              <div class="form-check">
                <label class="form-check-label">
                  ...
                  <?php echo trans('auth.register_policy', ['url' => 'https://monicahq.com/privacy', 'urlterm' => 'https://monicahq.com/terms', 'hreflang' => 'en', ]); ?>
              ...
              <div class="form-group actions">
                ...
                <button type="submit" class="btn btn-primary"><?php echo e(trans('auth.register_action')); ?></button>
              </div>
...
<?php echo $__env->make('marketing.skeleton', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/monica/resources/views/auth/register.blade.php ENDPATH**/ ?>